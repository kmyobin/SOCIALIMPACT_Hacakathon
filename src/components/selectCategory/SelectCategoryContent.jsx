  ...
  return (
    <section className="w-full relative">
      ...
      <section className="absolute w-full pt-10">
        ...
        <button
          className="w-[400px] h-[200px] border-4 border-[#505050] rounded-xl transition-all absolute top-24 left-6 bg-white flex justify-between px-14 items-center hover:border-[#5BBDF4] hover:scale-105"
          onClick={() => {
            navigate("/filming");
          }}
        >

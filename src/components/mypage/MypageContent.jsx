    ...
    <div className="flex h-full w-full flex-wrap justify-center">
      <div className="relative flex h-full w-full flex-col justify-between overflow-hidden bg-[#f6f6f6]">
        <div className="bg-[#5BBDF4] h-full w-full overflow-hidden">
          <div className="bg-[#5BBDF4] w-full px-7 flex py-2">
          ...
          <div
            className="h-full w-full overflow-hidden p-10 bg-[#f6f6f6] rounded-t-2xl"
          ...
          >
            ...
            <div className="h-[450px] overflow-y-scroll">
              <div className="drop-shadow-md shadow-gray-300 mb-5 rounded-xl p-3 bg-white flex py-5 ">
              ...
              <div className="drop-shadow-md shadow-gray-300 mb-5 rounded-xl p-3 bg-white flex py-5">
                ...
                <div className="w-4/5">경력 3년 이상</div>
              </div>
              <div className="drop-shadow-md shadow-gray-300 mb-5 rounded-xl p-3 bg-white flex py-5">
                <div className="w-1/5 justify-center items-center flex">
                  <img src={list_5} alt="list_5" width={25} height={25} />
                </div>
                <div className="w-4/5">교육업, 일본어</div>
              </div>
              <div className="drop-shadow-md shadow-gray-300 mb-5 rounded-xl p-3 bg-white flex py-5">
                <div className="w-1/5 justify-center items-center flex">
